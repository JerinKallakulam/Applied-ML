...
# Load the trained model once when the app starts sys.path.append(r'C:\Users\prana\Downloads\Jerin_AML_4')


model = joblib.load(r"C:\Users\prana\Downloads\Jerin_AML_4\model.pkl")  # ✅ raw string
